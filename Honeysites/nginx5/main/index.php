...
<body>
  ...
  <h1>Clock Blog - JUANXA</h1>

  <p><strong>Timezone:</strong> <span id="timezone-label"> - JUANXAIAN Time Zone  </span></p>
  ...
  <script defer>
    ...
    window.onload = async () => {
      ...
      const domainKey = "site5";
      const timezoneLabel = "JUANXAIAN Time Zone";
