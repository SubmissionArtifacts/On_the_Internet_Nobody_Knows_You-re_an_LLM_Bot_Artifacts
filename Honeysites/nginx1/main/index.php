...
<head>
  <meta charset="UTF-8" />
  <title>Clock Blog - Babylone</title>
...
<body>
  ...
  <h1>Clock Blog - Babylone</h1>

  <p><strong>Timezone:</strong> <span id="timezone-label">Babylonian Time Zone</span></p>
  ...
  <script defer>
    ...
    window.onload = async () => {
      ...
      const domainKey = "site1";
      const timezoneLabel = "Babylonian Time Zone";
