...
<head>
  <meta charset="UTF-8" />
  <title>Clock Blog - X879ILE</title>
...
<body>
  ...
  <h1>Clock Blog - X879ILE</h1>

  <p><strong>Timezone:</strong> <span id="timezone-label"> - X879ILEIAN Time Zone </span></p>
  ...
  <script defer>
    ...
    window.onload = async () => {
      ...
      const timezoneLabel = "X879ILEIAN Time Zone";
