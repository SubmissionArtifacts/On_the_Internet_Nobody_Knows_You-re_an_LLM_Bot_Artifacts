...
<head>
  <meta charset="UTF-8" />
  <title>Clock Blog - Coffee Kingdom</title>
...
<body>
  ...
  <h1>Clock Blog - Coffee Kingdom</h1>

  <p><strong>Timezone:</strong> <span id="timezone-label"> - Coffee Kingdom Time Zone </span></p>
  ...
  <script defer>
    ...
    window.onload = async () => {
      ...
      const domainKey = "site9";
      const timezoneLabel = "Coffee Kingdom Time Zone";
