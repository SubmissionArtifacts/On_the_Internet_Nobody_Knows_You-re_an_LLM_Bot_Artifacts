...
<head>
  <meta charset="UTF-8" />
  <title>Clock Blog - New Atlantis</title>
...
<body>
  ...
  <h1>Clock Blog - New Atlantis</h1>

  <p><strong>Timezone:</strong> <span id="timezone-label"> - New Atlantisian Time Zone </span></p>
  ...
  <script defer>
    ...
    window.onload = async () => {
      ...
      const domainKey = "site7";
      const timezoneLabel = "New Atlantisian Time Zone";
