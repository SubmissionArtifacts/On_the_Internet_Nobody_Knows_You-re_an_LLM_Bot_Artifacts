...
const PORT = 3001; // Use a different port to avoid conflict with the previous example

app.post('/verify-prosopo', async (req, res) => {
  //const data = req.body['procaptcha-response']
  //const token = req.body['procaptcha-response']
