...
$top_bar_links = [
  ...
  '<a href="https://site8.example.org" style="color: white; margin: 0 10px">Lonparislin</a>',
...
<body>
  ...
  <p><strong>Timezone:</strong> <span id="timezone-label">World Clock</span></p>
  ...
  <p><strong>Current Unique ID:</strong> <span id="unique-id"><?= $randomSessionId ?></p>
  ...
  <script defer>
    ...
    window.onload = async () => {
      ...
      const domainKey = "site0";
      const timezoneLabel = "World Clock";
