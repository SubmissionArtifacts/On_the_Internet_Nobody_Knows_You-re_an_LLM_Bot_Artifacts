...
<head>
  <meta charset="UTF-8" />
  <title>Clock Blog - Dessika</title>
...
<body>
  ...
  <h1>Clock Blog - Dessika</h1>

  <p><strong>Timezone:</strong> <span id="timezone-label"> - Dessikaian Time Zone </span></p>
  ...
  <script defer>
    ...
    window.onload = async () => {
      ...
      const timezoneLabel = "Dessikaian Time Zone";
