...
<head>
  <meta charset="UTF-8" />
  <title>Clock Blog - Akalaman</title>
...
<body>
  ...
  <h1>Clock Blog - Akalaman</h1>

  <p><strong>Timezone:</strong> <span id="timezone-label"> - Akalamanian Time Zone </span></p>
  ...
  <script defer>
    ...
    window.onload = async () => {
      ...
      const domainKey = "site2";
      const timezoneLabel = "Akalaman Time Zone";
